...
<form method="post" action="controller/productupdate.php" enctype="multipart/form-data">
...
?>
                ...
                <option value="<?php echo $row1['ca_id']?>" selected > <?php echo  $row1['ca_name'] ?> </option>
                <?php } ?>
</select>
		</div>
	</div>
	...
	<div class="form-group row" >
		...
		<div class="col-sm-12 col-md-10">
			<input class="form-control" value=<?php echo $row['pr_name']?>  name="pr_name"type="text" >
			<input class="form-control" value=<?php echo $row['pr_id']?>  name="prid" type="hidden" >
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-12 col-md-2 col-form-label"><b>Price per Kg</b></label>
		<div class="col-sm-12 col-md-10">
			<input class="form-control"name="pr_kg" value=<?php echo $row['pr_kg']?> type="number"  type="search">
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-12 col-md-2 col-form-label"><b>Product Details</b></label>
		<div class="col-sm-12 col-md-10">
		<textarea class="form-control" name="pr_details" id="exampleTextarea1" rows="8" ><?php echo $row['pr_details']?></textarea>
			<!--  <input class="form-control"type="text"name="pr_details" value=<?php echo $row['pr_details']?>> -->
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-12 col-md-2 col-form-label"><b>Product Quantity(In Kg)</b></label>
		<div class="col-sm-12 col-md-10">
			<input class="form-control" type="number"name="pr_quantity" value=<?php echo $row['pr_quantity']?>>
		</div>
	</div>
	<div class="form-group row">
