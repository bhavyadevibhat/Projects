...
<!-- <div class="main-panel">        
    ...
    <form method="post" action="controller/addblog.php"enctype="multipart/form-data" class="forms-sample">
          ...
          <div class="col-md-12">
             <div class="full">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                      <label for="exampleInputName1">Blog Highlight Title</label>
                      <input type="text" name="highlight" class="form-control" id="exampleInputName1" placeholder="Highlight"required>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Blog Description 1</label>
                      <textarea class="form-control" name="about1" id="exampleTextarea1" rows="8"required></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Blog Description 2</label>
                      <textarea class="form-control" name="about2" id="exampleTextarea1" rows="8"></textarea>
                    </div>
                    <div class="form-group">
                      <label>File upload</label>
                      <input type="file" name="img" class="file-upload-default">
